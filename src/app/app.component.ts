...
export class AppComponent implements OnInit, OnDestroy{
  ...
  ngOnInit(): void{
    ...
    this.titleService.setTitle( "Felipe Jaramillo | En el camino del desarrollo " );

    this.metaService.addTags([
      {name: 'keywords', content: 'Estudiante,Apcionado y constante'},
      {name: 'description', content: 'enfoque en la resolucion de problematicas utilizando la tecnologia '},
    ]);
